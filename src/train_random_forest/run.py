...
def go(args):
    ...
    # Fit the complete preprocessing and Random Forest pipeline.
    ...
    # Save the fitted pipeline in MLflow's scikit-learn model format.
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    # Impute and one-hot encode the non-ordinal categorical feature.
    ...
    reshape_to_1d = FunctionTransformer(np.ravel)
    ...
    # Combine preprocessing and prediction into the inference pipeline.
    sk_pipe = Pipeline(
        steps=[
