...
def parse_args():
    """Parse component arguments and rebuild descriptions split on Windows."""
    ...
    description = " ".join(args.artifact_description).strip()
    if len(description) >= 2 and description[0] == description[-1] == '"':
        description = description[1:-1]
    args.artifact_description = description
    return args
